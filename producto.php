    ...
    <article>
      <div class="product-card">
        ...
        <div class="product-image">
          <img id="imagenProducto" height="100%" width="100%">
        </div>
        <div class="product-info" style="width: 100%;">
          ...
          <input type="number" class="product-quantity" style="width: 100px;" placeholder="Cantidad a Llevar" min="1" id="Cantidad" value="1"><br>
          <label> Precio: </label>
